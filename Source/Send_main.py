...
class EmailInfo:
    def __init__(self, Date=None, From=None, To=None, Cc=None, Bcc=None,
...
class SendEmail:
    def __init__(self, sender_name, sender_email, to_email, cc_email, bcc_email,
                 subject, message, attachment_path, EmailInfo, smtp_server=None, smtp_port=None):
    ...
    def connect_server(self):
        ...
        self.client_socket.connect((self.server, int(self.port)))
    ...
    def send_id(self):
        # Send Message-ID
        message_id = self.generate_message_id(self)
        self.client_socket.send(
    ...
    def store_sent_email(self):
        ...
        current_folder = os.path.join(work_folder, self.sender_email)
        if not os.path.exists(current_folder):
            os.mkdir(current_folder)
            os.mkdir(os.path.join(current_folder, 'Sent'))
        sent_folder_path = os.path.join(current_folder, 'Sent')
...
def send(sender_name, sender_email, to_email, cc_email, bcc_email,
         subject, message, attachment_path, server, port):
    send_email = SendEmail
    send_email.__init__(send_email, sender_name, sender_email, to_email,
                        cc_email, bcc_email, subject, message, attachment_path, EmailInfo, server, port)
...
#     send("Brian",
#     "peter113@gmail.com",
#     "clientserver@gmail.com dangphuchung321@gmail.com",
#     "",
#     "bcc@gmail.com",
#     "subject",
#     "message",
