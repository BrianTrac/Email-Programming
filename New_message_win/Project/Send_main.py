...
class EmailInfo:
    def __init__(self, Date=None, To=None, Cc=None, Bcc=None, Subject=None, message=None):
        self.Date = Date
        self.To = To
        self.Cc = Cc
        self.Bcc = Bcc
...
def store_sent_email(date,
    ...
    email_folder_path = os.path.join(sent_folder_path, str(current_items+1))
...
# attachment_path = ["E:\\pixel.png", "E:\\08.pdf"]   
# send('Anh Khoa',
#      'anhkhoa@gmail.com',
#      'test@gmail.com',
#      'test@gmail.com',
